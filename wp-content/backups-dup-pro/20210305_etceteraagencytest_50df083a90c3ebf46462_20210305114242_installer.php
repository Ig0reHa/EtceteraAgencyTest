...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20210305_etceteraagencytest_50df083a90c3ebf46462_20210305114242_archive.zip';
    const ARCHIVE_SIZE       = '26631979';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = '50df083-05114242';
    const SECONDARY_PACKAGE_HASH = 'f580516-05114242';
    ...
    public function run()
    {
        ...
        $this->log('==DUPLICATOR INSTALLER BOOTSTRAP v4.0.0.1==');
        $this->log('----------------------------------------------------');
